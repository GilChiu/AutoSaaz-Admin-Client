  ...
  if (error || !ticket) {
    return (
      <div className="space-y-6">
        ...
        <button 
          onClick={() => navigate('/support/garages')}
          className="text-orange-500 hover:text-orange-600 font-medium"
        >
          ← Back to Garage Tickets
        </button>
      </div>
    );
  }
        ...
        {!isResolved && (
          <div className="mt-4 flex items-center gap-2">
            <input
              ...
              placeholder="Type your message to garage..."
              value={message}
...
export default SupportGarageChatPage;
